...
@interface TableLibraryViewController : UIViewController
@property (strong, nonatomic) IBOutlet UITableView *tableView;
@property(strong,nonatomic)NSString *uid;
@property(strong,nonatomic)NSString * likemin;
@property(strong,nonatomic)NSString * likemax;
@property(strong,nonatomic)NSString * nmin;
@property(strong,nonatomic)NSString * nmax;
